...
*/
;
angular.module('ldv.table.taf', ['ldv.templates.tripletable']).directive('tripleActions', function () {
  return {
    restrict: 'EA',
    transclude: false,
    replace: true,
...
;
angular.module('ldv.ui.legend', ['ldv.templates.ui']).directive('dbpvLegend', function () {
  return {
    restrict: 'EA',
    transclude: false,
    replace: true,
...
;
angular.module('ldv.ui.status', ['ldv.templates.ui']).directive('dbpvStatus', function () {
  return {
    restrict: 'EA',
    transclude: false,
    replace: true,
...
angular.module('triple-table/displayPredicates/displayPredicate.html', []).run([
  '$templateCache',
  function ($templateCache) {
    $templateCache.put('triple-table/displayPredicates/displayPredicate.html', '<div><div class="pred-name"><span display-node settings="" showlanguage="true" node="predicate" primarylang="primarylang" fallbacklang="fallbacklang"></span></div><div display-node-values about="about" predicate="predicate" values="predicate.values" valfilter="valfilter" primarylang="primarylang" fallbacklang="fallbacklang"></div></div>');
  }
]);
...
angular.module('ui/legend/legend.html', []).run([
  '$templateCache',
  function ($templateCache) {
    $templateCache.put('ui/legend/legend.html', '<div id="legend" ><h2 style="margin-top:0;">Legend</h2>\t<div class="container" id="legends">\t\t<div class="legend" ng-repeat="legend in legends">\t\t\t<div class="name">{{legend.name}}</div>\t\t\t<div class="description">{{legend.description}}</div>\t\t\t<div class="line" ng-repeat="line in legend.lines">\t\t\t\t<span ng-bind-html-unsafe="line.icon"></span> : {{line.text}}\t\t\t</div>\t\t</div>\t</div></div>');
  }
]);
...
angular.module('ui/notifications/notifications.html', []).run([
  '$templateCache',
  function ($templateCache) {
    $templateCache.put('ui/notifications/notifications.html', '\t\t\t<div id="notifications">\t\t\t\t<div class="notification" ng-click="removeNotification(notification);" ng-repeat="notification in notifications">\t\t\t\t\t<span class="text">{{notification.text}}</span>\t\t\t\t</div>\t\t\t</div>');
  }
]);
...
angular.module('ui/status/status.html', []).run([
  '$templateCache',
  function ($templateCache) {
    $templateCache.put('ui/status/status.html', '<div id="dbpv-status"><div ng-repeat="status in stasi" class="status-item"><span ng-bind-html-unsafe="status.icon" ng-click="removeStatus(status)"></span><span>{{status.text}}</span></div></div>');
  }
]);
