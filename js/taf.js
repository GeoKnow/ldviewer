...
// SHOW THE TYPES IN PRETTY BOX ---------> TRANSFERRED
/*
...
// SHOW LINKS IN PRETTY BOX (ONLY FORWARD!!!)  --------> TRANSFERRED
...
dbpv_taf_lodlive.check = function (about, predicate, value) {
	return value.type == "uri" && value.prefix != undefined && value.prefix.indexOf("dbpedia") == 0;
};
