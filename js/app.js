...
/*	
	...
	$rootScope.localgraph = "http://linkedgeodata.org";
	$rootScope.endpointgraph = ["http://linkedgeodata.org"];
	$rootScope.endpoint = "http://linkedgeodata.org/sparql";
	$rootScope.encodegraph = true;
	
	$rootScope.owlgraph = "http://linkedgeodata.org";
	$rootScope.owlendpoint = "http://linkedgeodata.org/sparql";
