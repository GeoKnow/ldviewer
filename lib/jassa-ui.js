...
angular.module("template/facet-tree/facet-dir-ctrl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/facet-tree/facet-dir-ctrl.html",
    ...
    "\n" +
    "		<form role=\"form\" ng-submit=\"doFilter(dirset.path, dirset.filter.filterString)\">\n" +
	"			<div class=\"input-group\">"+
    "\n" +
    "				<input type=\"text\" style='padding:0;height:auto;' class=\"form-control input-sm\" placeholder=\"Filter\" ng-model=\"dirset.filter.filterString\" value=\"{{dirset.filter.filterString}}\" />\n" +
    "			<div class=\"input-group-btn\">\n" +
    "				<button type=\"submit\" style=\"padding:0 1em;font-size:0.8em\" class=\"btn btn-default input-sm\"><span class=\"glyphicon glyphicon-filter\"></span></button>\n" +
    "			</div>\n" +
	
    "\n</div>" +
    "			<div ng-show=\"dirset.pageCount > 1\" style=\"background-color: #eeeeff\">\n" +
    "				<pagination\n" +
    "					style=\"margin:0;\"\n" +
    "					class=\"pagination-tiny\" max-size=\"3\"\n" +
    "					total-items=\"dirset.childFacetCount\" page=\"dirset.pageIndex\"\n" +
    "					boundary-links=\"true\" direction-links='false' rotate=\"true\"\n" +
...
angular.module("template/facet-tree/facet-tree-item.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/facet-tree/facet-tree-item.html",
    ...
    "\n" +
    "		<a href=\"\" title=\"Showing incoming facets. Click to show outgoing facets.\" ng-show=\"facet.isExpanded && facet.isIncomingActive\" ng-click=\"selectOutgoing(facet.item.getPath())\"><span class=\"glyphicon glyphicon-arrow-left\"></span></a>\n" +
    "		<a href=\"\" title=\"Showing outgoing facets. Click to show incoming facets.\" ng-show=\"facet.isExpanded && facet.isOutgoingActive\" ng-click=\"selectIncoming(facet.item.getPath())\"><span class=\"glyphicon glyphicon-arrow-right\"></span></a>\n" +
    "\n" +
    "\n" +
    ...
    "		\n" +
    "		<div ng-show=\"facet.isExpanded && facet.isIncomingActive && dirset.children.length > 0\" style=\"width:100%\" ng-repeat=\"dirset in [facet.incoming]\" ng-include=\"'template/facet-tree/facet-dir-ctrl.html'\"></div>\n" +
    "		<div ng-show=\"facet.isExpanded && facet.isOutgoingActive && dirset.children.length > 0\" style=\"width:100%\" ng-repeat=\"dirset in [facet.outgoing]\" ng-include=\"'template/facet-tree/facet-dir-ctrl.html'\"></div>\n" +    
	//"		<div ng-show=\"facet.isExpanded && facet.isHovered && facet.isIncomingActive\" style=\"width:100%\" ng-repeat=\"dirset in [facet.incoming]\" ng-include=\"'template/facet-tree/facet-dir-ctrl.html'\"></div>\n" +
    //"		<div ng-show=\"facet.isExpanded && facet.isHovered && facet.isOutgoingActive\" style=\"width:100%\" ng-repeat=\"dirset in [facet.outgoing]\" ng-include=\"'template/facet-tree/facet-dir-ctrl.html'\"></div>\n" +
    "	</div>\n" +
    "	<div ng-show=\"facet.isExpanded\" style=\"width:100%\"> \n" +
    "\n" +
    "\n" +
    "			<div ng-show=\"facet.isExpanded && facet.isIncomingActive  \" ng-repeat=\"dirset in [facet.incoming]\" ng-include=\"'template/facet-tree/facet-dir-content.html'\"></div>\n" +
    "			<div ng-show=\"facet.isExpanded && facet.isOutgoingActive  \" ng-repeat=\"dirset in [facet.outgoing]\" ng-include=\"'template/facet-tree/facet-dir-content.html'\"></div>\n" +
    "\n" +
    "\n" +
    "<!-- 		<tabset class=\"tabset-small\"> -->\n" +
    "<!-- 			<tab heading=\"Incoming Facets\" active=\"{{facet.isIncomingActive  }}\" select=\"selectIncoming(facet.item.getPath())\"> -->\n" +
    "<!-- 				<div ng-repeat=\"dirset in [facet.incoming]\" ng-include=\"'template/facet-tree/facet-dir-content.html'\"></div> -->\n" +
    "<!-- 			</tab> -->\n" +
    "<!-- 			<tab heading=\"Outgoing Facets\" active=\"{{facet.isOutgoingActive  }}\" select=\"selectOutgoing(facet.item.getPath())\">					 -->\n" +
